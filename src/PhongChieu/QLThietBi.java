...
//            CallableStatement callableStatement =(CallableStatement) connection.prepareCall("{call xemthietbi(?)}");
//            int matb=1;
//            callableStatement.setInt(1, matb);
//            
...
//             ResultSet resultSet = callableStatement.executeQuery();
            ...
            {
               ThietBi p = new ThietBi(resultSet.getString("MATB"), resultSet.getString("TenTB"), resultSet.getString("hangsx"), resultSet.getInt("Sl"));
               TBList.add(p);
